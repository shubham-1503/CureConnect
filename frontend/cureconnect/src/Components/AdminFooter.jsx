    ...
    <footer className="w-full bg-secondaryColor p-3">
      <div className="max-w-screen-lg px-4 sm:px-6 text-backgroundColor sm:grid lg:grid-cols-4 md:grid-cols-2 mx-auto ">
        ...
        <div className="p-5">
          ...
          <a
            className="my-3 font-semibold block hover:font-extrabold transition duration-150 ease-in-out hover:text-primaryColor hover:cursor-pointer"
            onClick={() => handleRouting("inventory")}
          >
            Inventory
          </a>
          <a
            className="my-3 font-semibold block hover:font-extrabold transition duration-150 ease-in-out hover:text-primaryColor hover:cursor-pointer"
            onClick={() => handleRouting("approval")}
          >
            Doctor's Approval
          </a>
        </div>
        ...
        <div className="p-5">
          ...
          <a
            className="my-3 font-semibold block hover:font-extrabold transition duration-150 ease-in-out hover:text-primaryColor hover:cursor-pointer"
            onClick={() => handleRouting("contactus")}
          >
            2495 Maynard St, Halifax, CA
          </a>
          <a
            className="my-3 font-semibold block hover:font-extrabold transition duration-150 ease-in-out hover:text-primaryColor hover:cursor-pointer"
            onClick={() => handleRouting("contactus")}
          >
            contact@cureconnect.com{" "}
          </a>
        </div>
      </div>
      <div className="pt-2">
        <div className="flex pb-5 px-3 m-auto pt-5 border-t text-whiteColor text-sm flex-col max-w-screen-lg items-center">
          <div className="mt-2 flex-row flex">
            <a href="/#" className="w-6 mx-2">
              {" "}
              <FaFacebookF
                className="hover:text-primaryColor transition duration-150 ease-in-out hover:cursor-pointer"
                size={30}
              />{" "}
            </a>
            <a href="/#" className="w-6 mx-2">
